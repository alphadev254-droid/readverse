...
class _TxtReaderState extends State<TxtReader> {
  ...
  Future<void> _initialLoad() async {
    ...
    // Load text file in background isolate to avoid blocking UI
    final raw = await compute(_loadTextInIsolate, widget.document.filePath);
  ...
  static Future<String> _loadTextInIsolate(String filePath) async {
  ...
  // Called by slider drag — converts fraction to page
