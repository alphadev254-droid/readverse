          ...
          ListTile(
            ...
            trailing: DropdownButton<String>(
              ...
              items: ['Serif', 'Sans-serif', 'Monospace']
                  ...
                  .toList(),
              onChanged: (v) {
                if (v != null) theme.setFontFamily(v);
              },
            ),
          ),
          ListTile(
            ...
            trailing: SegmentedButton<String>(
              segments: const [
                ...
                ButtonSegment(
                    value: 'Relaxed',
                    label: Text('Relaxed', style: TextStyle(fontSize: 11))),
              ],
          ...
          ListTile(
            ...
            subtitle: Padding(
              ...
              child: Row(
                children: [
                  _BgColorOption(
                      color: AppColors.readingWhite,
                      label: 'White',
                      selected: theme.readingBackground == AppColors.readingWhite,
                      onTap: () => theme.setReadingBackground(AppColors.readingWhite)),
                  const SizedBox(width: 12),
                  _BgColorOption(
                      color: AppColors.readingSepia,
                      label: 'Sepia',
                      selected: theme.readingBackground == AppColors.readingSepia,
                      onTap: () => theme.setReadingBackground(AppColors.readingSepia)),
                  const SizedBox(width: 12),
                  _BgColorOption(
                      color: AppColors.readingDark,
                      label: 'Dark',
                      selected: theme.readingBackground == AppColors.readingDark,
                      onTap: () => theme.setReadingBackground(AppColors.readingDark)),
                  const SizedBox(width: 12),
                  _BgColorOption(
                      color: AppColors.readingBlack,
                      label: 'Black',
                      selected: theme.readingBackground == AppColors.readingBlack,
                      onTap: () => theme.setReadingBackground(AppColors.readingBlack)),
                ],
              ),
            ),
          ),
                    ...
                    .map((color) => GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: theme.accentColor.toARGB32() ==
                                      color.toARGB32()
                                  ? Border.all(
                            ...
                            child: theme.accentColor.toARGB32() ==
                                    color.toARGB32()
          ...
          ListTile(
            ...
            trailing: DropdownButton<String>(
              ...
              items: AppConstants.ttsLanguages
                  ...
                  .toList(),
              onChanged: (v) {
                if (v != null) settings.setTtsVoice(v);
              },
            ),
          ),
        ],
      ...
      builder: (_, settings, __) => Column(
        children: [
          ...
          ListTile(
            ...
            subtitle: const Text('Removes temporary files only'),
  ...
  void _confirmClearCache(BuildContext context, SettingsProvider settings) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        title: const Text('Clear Cache'),
        content: const Text(
            'This will clear temporary files. Your documents and recordings will not be deleted.'),
        actions: [
          TextButton(
              onPressed: () => Navigator.pop(context),
              child: const Text('Cancel')),
          FilledButton(
            onPressed: () async {
              ...
              if (context.mounted)
                context.showSnackBar('Cache cleared', isSuccess: true);
            },
